...
```bash
# RUS→KBD: Ищи русские предложения с ключевыми словами
grep -i -m 5 "вижу.*дом\|дом.*вижу" data/translations/sents_292k.csv

# KBD→RUS: Ищи кабардинские предложения с ключевыми словами
grep -i -m 5 "слъагъу.*унэр\|унэр.*слъагъу" data/translations/sents_292k.csv
```
