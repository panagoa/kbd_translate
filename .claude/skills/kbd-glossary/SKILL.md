...
Skill:
1. Ищет точное совпадение: не найдено
2. Ищет частичное совпадение: найдены похожие термины
3. Сообщает:
   "Точное совпадение не найдено.
   Возможно вы ищете:
   - компьютер (транслитерация)
   - [похожие технические термины]"
```
